...
(t5 <- Sys.time() - now)
save(models5, file = "results/lda_k_5.zip")
```
...
(t10 <- Sys.time() - now)
save(models10, file = "results/lda_k_10.zip")
```
...
(t15 <- Sys.time() - now)
save(models15, file = "results/lda_k_15.zip")
```
...
(t20 <- Sys.time() - now)
save(models20, file = "results/lda_k_20.zip")
```
...
(t25 <- Sys.time() - now)
save(models25, file = "results/lda_k_25.zip")
```
...
(t30 <- Sys.time() - now)
save(models30, file = "results/lda_k_30.zip")
```