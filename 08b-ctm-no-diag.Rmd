...
```{r}
# Create holdout set
holdout <- make.heldout(documents = sparse$documents, vocab = sparse$vocab,
...
# 10
gc()
nc_ctm10 <- stm(holdout$documents, holdout$vocab, K = 10, init.type = "Spectral", ngroups = 7,
  control = list(maxV = length(holdout$vocab)), sigma.prior = 1)
save(nc_ctm10, file = "results/nc_ctm10.zip", compress = "xz", compression_level = 1)

# 15
gc()
nc_ctm15 <- stm(holdout$documents, holdout$vocab, K = 15, init.type = "Spectral", ngroups = 7,
  control = list(maxV = length(holdout$vocab)), sigma.prior = 1)
save(nc_ctm15, file = "results/nc_ctm15.zip", compress = "xz", compression_level = 1)

# 20
gc()
nc_ctm20 <- stm(holdout$documents, holdout$vocab, K = 20, init.type = "Spectral", ngroups = 7,
  control = list(maxV = length(holdout$vocab)), sigma.prior = 1)
save(nc_ctm20, file = "results/nc_ctm20.zip", compress = "xz", compression_level = 1)

# 25
gc()
nc_ctm25 <- stm(holdout$documents, holdout$vocab, K = 25, init.type = "Spectral", ngroups = 7,
  control = list(maxV = length(holdout$vocab)), sigma.prior = 1)
save(nc_ctm25, file = "results/nc_ctm25.zip", compress = "xz", compression_level = 1)

# 30
gc()
nc_ctm30 <- stm(holdout$documents, holdout$vocab, K = 30, init.type = "Spectral", ngroups = 7,
  control = list(maxV = length(holdout$vocab)), sigma.prior = 1)
save(nc_ctm30, file = "results/nc_ctm30.zip", compress = "xz", compression_level = 1)

# 35
gc()
nc_ctm35 <- stm(holdout$documents, holdout$vocab, K = 35, init.type = "Spectral", ngroups = 7,
  control = list(maxV = length(holdout$vocab)), sigma.prior = 1)
save(nc_ctm35, file = "results/nc_ctm35.zip", compress = "xz", compression_level = 1)

# 40
gc()
nc_ctm40 <- stm(holdout$documents, holdout$vocab, K = 40, init.type = "Spectral", ngroups = 7,
  control = list(maxV = length(holdout$vocab)), sigma.prior = 1)
save(nc_ctm40, file = "results/nc_ctm40.zip", compress = "xz", compression_level = 1)

# 45
gc()
nc_ctm45 <- stm(holdout$documents, holdout$vocab, K = 45, init.type = "Spectral", ngroups = 7,
  control = list(maxV = length(holdout$vocab)), sigma.prior = 1)
save(nc_ctm45, file = "results/nc_ctm45.zip", compress = "xz", compression_level = 1)

# 50
gc()
nc_ctm50 <- stm(holdout$documents, holdout$vocab, K = 50, init.type = "Spectral", ngroups = 7,
  control = list(maxV = length(holdout$vocab)), sigma.prior = 1)
save(nc_ctm50, file = "results/nc_ctm50.zip", compress = "xz", compression_level = 1)
```
