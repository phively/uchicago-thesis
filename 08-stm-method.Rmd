...
## Test the holdout functions

```{r}
holdout <- make.heldout(extra_sparse$documents, extra_sparse$vocab, proportion = 1, seed = 123)
```
...
```{r}
save(ctm5, ctm10, ctm15, ctm20, ctm25, ctm30, ctm35, ctm40, ctm45, ctm50, nc_ctm40,
